...
@section('content')
    ...
    <div class="container py-4">
        ...
        {{-- Header - PAKAI CLASS bg-gradient-header (konsisten dengan dashboard) --}}
        <div class="card border-0 rounded-4 mb-4 bg-gradient-header shadow">
            <div class="card-body px-4 py-4">
                <h5 class="fw-bold mb-1 text-white">Tambah Guru Baru</h5>
                <p class="mb-0 text-white opacity-75 small">Isi data guru dan kredensial akun</p>
            </div>
        </div>

        {{-- Alert error - DIREPAIR lebih modern --}}
        @if ($errors->any())
            ...
            <div class="row g-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="tel" name="nip" inputmode="numeric"
                                        ...
                                        maxlength="18" pattern="[0-9]{18}" title="NIP harus 18 digit angka" required>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body px-4 py-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="username" name="username"
                                    class="form-control @error('username') is-invalid @enderror" placeholder="Nama atau NIP"
                                    required>
                            </div>
                            <div class="mb-0">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('admin.guru.index') }}" class="btn btn-outline-secondary py-2">
                            Batal
                        </a>
                    </div>
                </div>
